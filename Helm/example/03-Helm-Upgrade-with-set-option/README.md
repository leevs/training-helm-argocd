...
# Add Helm Repository
helm repo add <DESIRED-NAME> <HELM-REPO-
.rwxr-xr-x leevansteerthem staff 146 B  Tue Oct 17 13:42:37 2023  git-deploy.sh
drwxr-xr-x leevansteerthem staff 1.7 KB Tue Oct 17 13:42:37 2023  .URL>
...
# Port Forward 
k port-forward svc/myapp1-mychart1 8080:80
# Access Application
http://localhost:8080
```
